...
if(isset($_POST["kaydet"])){
    ...
    $ekle = "INSERT INTO kullanicilar (kullanici_adi, kullanici_soyadi, email, telno, parola) VALUES ('$name', '$sname', '$email', '$telno', '$sifre')";
...
<body>
    ...
    <form class="f1" action="kayit.php" method="POST">
        ...
        <input type="text" id="telefon" name="telefon" pattern="[0-9]{10}" title="10 haneli telefon numarası giriniz" required>

        <label for="sifre">Şifre:</label>
        <input type="password" id="sifre" name="sifre" minlength="6" required>

        <button type="submit" class="buton5" name="kaydet">Kayıt Ol</button>
        <br><br>
        <a href="login.php">Zaten üye misiniz? Giriş yapmak için tıklayınız.</a>
    </form>
